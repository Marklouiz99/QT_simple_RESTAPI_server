...
namespace {
struct qt_meta_tag_ZN14HttpConnectionE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN14HttpConnectionE = QtMocHelpers::stringData(
    "HttpConnection",
    "ReadyRead",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14HttpConnectionE[] = {
...
Q_CONSTINIT const QMetaObject HttpConnection::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14HttpConnectionE.offsetsAndSizes,
    qt_meta_data_ZN14HttpConnectionE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14HttpConnectionE_t,
        // Q_OBJECT / Q_GADGET
...
void *HttpConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14HttpConnectionE.stringdata0))
